    ...
    <center>
        ...
        <div class="courses-box bg-light">
            <div class="container py-4">
                ...
                <h1 class="text-center border-bottom pb-3 mb-4">Courses</h1>

                <div class="search-box input-group group w-75 m-auto mb-4">
                            ...
                            <div class="col-md-8">
                                <div class="card-body row align-items-end h-100">
                                    <div class="row">
                                        ...
                                        <h5 class="card-title course-info">'.$row['course_name'].'</h5>
                                        ...
                                        <div class="d-flex row justify-content-between align-items-center">
                                            ...
                                            if(isset($_SESSION['UserID']) && !($MyCoursesUser == NULL) && in_array($row['course_id'], $MyCoursesUser) ){
                                                ...
                                                echo '<div class="col-md-6 col-sm-12 text-end">
                                                <a course_id="' . $row['course_id'] . '" class="btn btn-primary course-btn addCourseBtn">Add Course</a>
                                            </div>';
                                            }
    ...
    $(".addCourseBtn").click(function(event) {
        ...
        $.ajax({
            ...
            success: function(data) {
                alert("(" + course_title + ") Course has been added to My Courses page.");
